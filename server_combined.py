...
# Accept GET & HEAD for uptime monitors (UptimeRobot, etc.)
...
def bot_heartbeat_loop():
    """Periodically call Telegram getMe → cached status for /botok."""
...
# New: cancel auto-renew via your web backend (optional)
